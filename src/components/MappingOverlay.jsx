        ...
        return (
          <div
            ...
            style={{
              ...
              border: isHighlighted ? '3px solid var(--accent)' : '2px dashed var(--accent)',
              borderRadius: '4px',
              backgroundColor: isHighlighted ? 'var(--accent-light)' : 'rgba(99, 102, 241, 0.05)',
              boxShadow: isHighlighted ? '0 0 15px var(--accent-glow)' : 'none',
